...
SECRET_KEY = 'django-insecure-%#yl@&e3^m)q3onerf7h0w*0i30rav+@mwi234re)@xm)n&yh2'
...
JAZZMIN_SETTINGS = {
    ...
    "welcome_sign": "Welcome to the Smart Ta'lim",

    # Copyright on the footer
    "copyright": "My CRM Ltd",

    # List of model admins to search from the search bar, search bar omitted if excluded
    # If you want to use a single search field you dont need to use a list, you can use a simple string 
    "search_model": ["center.User"],
    ...
    "topmenu_links": [
        ...
        {"model": "center.Director"},
         {"model": "center.Manager"},
          {"model": "center.Teacher"},
